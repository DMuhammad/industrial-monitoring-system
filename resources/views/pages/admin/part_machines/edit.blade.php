        ...
        <div class="container-fluid p-0">
            <div class="card mb-3">
                <div class="card-header mt-3">
                    <h3 class="m-0">Update Part Machine</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('partmachines.update', $partmachine->id) }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select-item" name="machine_id" id="machine_id">
                                ...
                                @foreach ($machines as $machine)
                                    @if (old('machine_id', $partmachine->machine_id) == $machine->id)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('part_name') is_invalid @enderror"
                                id="part_name" name="part_name" value="{{ old('part_name', $partmachine->part_name) }}" autofocus required>
                            @error('part_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('standard_hourmeter') is_invalid @enderror"
                                id="standard_hourmeter" name="standard_hourmeter" value="{{ old('standard_hourmeter', $partmachine->standard_hourmeter) }}"
                                autofocus required>
