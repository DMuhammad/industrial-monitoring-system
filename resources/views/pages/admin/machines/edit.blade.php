        ...
        <div class="container-fluid p-0">
            <div class="card mb-3">
                <div class="card-header mt-3">
                    <h3 class="m-0">Update Machine</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('machines.update', $machine->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select select-item" name="parent_id" id="parent_id">
                                ...
                                @foreach ($parentmachines as $parentmachine)
                                    @if (old('parent_id', $machine->parent_id) == $parentmachine->id)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('machine_name') is_invalid @enderror"
                                id="machine_name" name="machine_name" value="{{ old('machine_name', $machine->machine_name) }}" autofocus required>
                            @error('machine_name')
