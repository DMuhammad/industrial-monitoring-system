...
var initializeSidebarCollapse = function initializeSidebarCollapse() {
  var sidebarElement = document.getElementsByClassName("sidebar-menu")[0];
  var sidebarToggleElement = document.getElementsByClassName("sidebar-hamburger-toggle")[0];
...
document.addEventListener("DOMContentLoaded", function () {
  return initializeSidebarCollapse();
});
